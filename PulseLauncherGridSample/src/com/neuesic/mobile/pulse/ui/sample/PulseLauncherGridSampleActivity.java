...
public class PulseLauncherGridSampleActivity extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (!adapter.restore()) {
			...
			items.add(new LauncherGridItem(R.drawable.ic_launcher, "Item 1",
					intent));
			...
			LauncherGridItem item2 = new LauncherGridItem(
					R.drawable.ic_launcher, "Item 2", intent2);
			...
			items.add(new LauncherGridItem(R.drawable.ic_launcher, "Item 3",
					intent3));
